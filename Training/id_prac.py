...
driver.find_element('id','name').send_keys('nazreen')
time.sleep(1)

driver.find_element('id','email').send_keys('nazreen@gmail.com')
time.sleep(1)

driver.find_element('id','phone').send_keys('9876543219')
time.sleep(1)
